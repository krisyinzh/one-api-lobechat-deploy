好的，作为一名运维工程师，文档的规范性和易读性非常重要。我为你整理了一份可以直接复制到 GitHub `README.md` 的代码块。

我特别针对你的环境进行了优化，并加入了一些 Markdown 的排版技巧（如代码高亮、引用提示等），让教程看起来更专业。
...
### 操作提示：
1. 在你的 GitHub 仓库点击 **"Create new file"**。
2. 文件名填写 `README.md`。
3. 将上面的内容全部粘贴进去。
4. 点击页面底部的 **"Commit changes"** 即可看到精美的排版效果！
